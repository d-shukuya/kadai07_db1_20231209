...
$stmt = $pdo->prepare("
  ...
  VALUES(
    NULL, :bookId, :pageNum, :lineNum, :content, sysdate(), sysdate()
  )");

// 2-2. バインド変数を定義
$stmt->bindValue(':bookId', (int)$_POST["book_id"], PDO::PARAM_INT);
$stmt->bindValue(':pageNum', $_POST["page_num"], PDO::PARAM_INT);
$stmt->bindValue(':lineNum', $_POST["line_num"], PDO::PARAM_INT);
